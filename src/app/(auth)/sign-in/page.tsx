      ...
      <div className="w-full max-w-md bg-card rounded-[2rem] shadow-xl border border-border p-8 md:p-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground">
            Login to your WhisperBox account
          </p>
        </div>
        ...
        <Button
          onClick={()=>{toast.add({type:"info",description:"Login With Google is Currently Disabled"})}}
          variant="outline"
          className="w-full rounded-xl h-11 border-border/60 hover:bg-muted/50 font-medium cursor-pointer">
